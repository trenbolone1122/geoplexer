...
Globe exploration app powered by the Perplexity API, with local weather, nearby places recommendations, and local bookmarks/history stored in your browser.

<img src="assets/screenshot.png" width="1100" alt="Geoplexer screenshot" />
